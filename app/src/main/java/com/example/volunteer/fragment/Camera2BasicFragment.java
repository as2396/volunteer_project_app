...
import com.example.volunteer.View.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment
    ...
    private boolean mAutoFocusSuported;
    ...
    private void setUpCameraOutputs(int width, int height,int facingId) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                int[] afAvailableModes = characteristics.get(CameraCharacteristics.COLOR_CORRECTION_AVAILABLE_ABERRATION_MODES);

                if(afAvailableModes.length ==0 || (afAvailableModes.length ==1
                        && afAvailableModes[0] == CameraMetadata.CONTROL_AE_MODE_OFF)){
                    mAutoFocusSuported = false;
                }else{
                    mAutoFocusSuported = true;
                }
